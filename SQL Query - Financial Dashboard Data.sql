...
COPY cc_detail
FROM 'Location path of credit_card.csv in your machine' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'Location path of customer.csv in your machine' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'Location path of cc_add.csv in your machine' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'Location path of cust_add.csv in your machine' 
DELIMITER ',' 
CSV HEADER;
